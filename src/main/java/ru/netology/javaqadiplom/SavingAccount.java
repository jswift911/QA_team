    ...
    public SavingAccount(int initialBalance, int minBalance, int maxBalance, int rate) {
        ...
        if (minBalance > maxBalance) {
            throw new IllegalArgumentException(
                    ...
                    " а у вас минимальный: " + minBalance +
                    " , а максимальный: " + maxBalance
            );
        }
        if (initialBalance < minBalance || initialBalance > maxBalance) {
            throw new IllegalArgumentException(
                    "Начальный баланс должен быть в пределах минимального и максимального балансов," +
                    " а у вас минимальный: " + minBalance +
                    " , максимальный: " + maxBalance +
                    " , а начальный: " + initialBalance
            );
        }
